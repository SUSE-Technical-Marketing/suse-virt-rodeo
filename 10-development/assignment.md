...
tabs:
- id: qv81mvqyq5rp
  title: harvester_from_kvm-host8443
  type: service
  hostname: kvm-host
  path: /
  port: 8443
...
URL <b >kvm-host</b>: <a href="https://kvm-host.[[ Instruqt-Var key="_SANDBOX_ID" hostname="kvm-host" ]].instruqt.io">https://kvm-host.[[ Instruqt-Var key="_SANDBOX_ID" hostname="kvm-host" ]].instruqt.io</a>
